...
const Addnews = () => {
    ...
    const handleSubmit = (e) => {
        ...
        RequestMethod("/post", "post", { ...inputs, userId: currentUser._id, image }, currentUser.token).then(res => {
            if (res) {
                ...
                <div className="w-[75%] m-auto">
                    <form className='bg-slate-200 flex-[2] p-[3rem]' onSubmit={handleSubmit}>
                        <div className="flex items-center justify-between my-[2rem]">
                            <div className="">
                                <h1 className='text-3xl font-semibold'>Add News </h1>
                                <p className='text-gray-500 mt-2'>Add new details like Title, Description Category, Location and images</p>
                            </div>
                            <div className=" flex gap-5">
                                <button type='submit' className='bg-black text-white px-5 py-1 rounded-md'>Publish</button>
                        ...
                        <div className="flex gap-5">
                            <div className=" flex-[2] bg-white flex flex-col gap-5 p-[2rem]">
                                ...
                                <div className="flex flex-col gap-2 w-full">
                                    ...
                                    <div className="border border-gray-600 flex items-center py-[0.6rem] px-[1rem] gap-4 rounded-lg">
                                        <input type="text" name="title" placeholder='Title' id="" className=' rounded-lg focus:outline-none w-full' required onChange={handleChange} />
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 ">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="border border-gray-600 flex items-center py-[0.5rem] px-[1rem] gap-4 rounded-lg  w-full">
                                            ...
                                            <input type="text" name="location" placeholder='Location' id="" className=' rounded-lg focus:outline-none' onChange={handleChange} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-2 w-full">
                                        ...
                                        <select name="category" id="" className='border border-gray-600 p-2 rounded-md' required onChange={handleChange}>
                                ...
                                <div className="flex flex-col gap-2 w-full">
                                    ...
                                    <textarea type="text" rows={10} name="desc" placeholder='New Description' id="" className='border border-gray-700 rounded-lg focus:outline-none py-[0.6rem] px-[1rem]' onChange={handleChange} />
                                </div>
                            </div>
                            <div className="flex-[1] bg-white w-full h-[55vh] p-[1rem] flex gap-4 flex-col">
                                ...
                                <hr />
                                <img className='w-[100%] h-[25vh] rounded-lg object-cover' src={image ? image : "https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg"} alt="" />
